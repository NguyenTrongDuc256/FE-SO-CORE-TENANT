...
import {
  ...
  PAGE_INDEX_DEFAULT,
  PAGE_SIZE_DEFAULT,
  PAGE_SIZE_OPTIONS_DEFAULT, SCOPE_NOTIFICATION, STATUS_NOTIFICATION
} from "../../../../../_shared/utils/constant";
import {
  CreatedByList,
  NotificationList,
} from "../../../../../_models/layout-student/notification/notification.model";
...
@Component({
  ...
  templateUrl: './notification-list-student.component.html',
  styleUrls: ['./notification-list-student.component.scss','../../helper.scss']
})
export class NotificationListStudentComponent implements OnInit {
