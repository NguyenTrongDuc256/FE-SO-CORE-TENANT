...
@Component({
  selector: 'app-modal-update-absent-parent',
  templateUrl: './modal-update-absent-parent.component.html',
  styleUrls: ['./modal-update-absent-parent.component.scss']
})
export class ModalUpdateAbsentParentComponent implements OnInit {
  @Input() dataModal: any;
  ...
  updateAbsent() {
    ...
    this.listenFireBase('update', 'absent_parent');
    this.absentManagerParentService.updateAbsent(dataRequest).subscribe((res: any) => {
    }, (err: any) => {
      this.isLoading = false;
