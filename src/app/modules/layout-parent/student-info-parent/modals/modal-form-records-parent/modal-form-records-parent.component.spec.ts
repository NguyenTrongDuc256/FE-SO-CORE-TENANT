...
import { ModalFormRecordsParentComponent } from './modal-form-records-parent.component';
...
describe('ModalFormRecordsStaffComponent', () => {
  let component: ModalFormRecordsParentComponent;
  let fixture: ComponentFixture<ModalFormRecordsParentComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [ModalFormRecordsParentComponent],
      imports: [
        CommonModule,
        CoreModule,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ModalFormRecordsParentComponent);
