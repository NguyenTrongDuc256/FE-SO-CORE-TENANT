...
@Component({
  selector: 'app-update-student-staff',
  templateUrl: './update-student-staff.component.html',
  styleUrls: ['./update-student-staff.component.scss']
})
export class UpdateStudentStaffComponent implements OnInit {
  ...
  updateStudent() {
    ...
    this.studentStaffService.updateStudent(dataRequest).subscribe((res: any) => {
