...
export class UpdateUsernameCodeTenantComponent implements OnInit {
  ...
  validation_messages = {
    'code': [
      { type: 'required', message: 'student.validators.code.required' },
      { type: 'pattern', message: 'student.validators.code.pattern' },
      { type: 'maxlength', message: 'student.validators.code.maxlength' },
