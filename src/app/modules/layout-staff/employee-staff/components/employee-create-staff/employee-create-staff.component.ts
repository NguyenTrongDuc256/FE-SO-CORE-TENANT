...
import {EmployeeFormStaff} from "../../../../../_models/layout-staff/employee/employee-staff.model";

@Component({
  selector: 'app-employee-create-staff',
  templateUrl: './employee-create-staff.component.html',
  styleUrls: ['./employee-create-staff.component.scss']
})
export class EmployeeCreateStaffComponent implements OnInit {
  ...
  schoolNameCurrent: string = localStorage.getItem('currentUnit') ? JSON.parse(localStorage.getItem('currentUnit'))?.name : null;
  ...
  ngOnInit(): void {
    this.schoolNameCurrent = localStorage.getItem('currentUnit') ? JSON.parse(localStorage.getItem('currentUnit'))?.name : null;
    ...
    if (this.employeeId) {
      this.initForm();
      this.isUpdate = true;
      const APIInitializationData = this.employeeStaffService.getInitializationData();
      const APIEmployeeInfo = this.employeeStaffService.detail(this.employeeId);
  ...
  initForm(): void {
    this.formGroup = this.fb.group({
      ...
      password: this.employeeInfo ? ['matKhauHienThi'] : // 5 nếu update thì bỏ validate, không gửi field này khi submit
  ...
  storeOrUpdate(formValue): void {
    ...
    let dataInput: EmployeeFormStaff = {
    ...
    if (this.isUpdate) {
      ...
      this.employeeStaffService.update(dataInput).subscribe(
        (res: any) => {
        }, (_err: any) => {
      ...
      this.employeeStaffService.store(dataInput).subscribe(
        (res: any) => {
        }, (_err: any) => {
          this.validateAllFormFieldsErrorServer(_err.errors);
          this.isLoading = false;
  ...
  getDistrictList(cityCode: string): void {
    this.isLoading = true;
    this.locationService.getDistrictList(cityCode).subscribe(
      (res: any): void => {
  ...
  openModalDienBienLuong(): void {
    const modalRef = this.modalService.open(ModalDienBienLuongStaffComponent,
      {
        scrollable: true,
  ...
  openModalNgoaiNgu(): void {
    const modalRef = this.modalService.open(ModalDiemNgoaiNguStaffComponent,
      {
        scrollable: true,
        windowClass: 'myCustomModalClass',
        backdrop: 'static',
  ...
  openModalQuaTrinhDaoTaoBD(): void {
    const modalRef = this.modalService.open(ModalQuaTrinhDaoTaoBoiDuongStaffComponent,
      {
        scrollable: true,
        windowClass: 'myCustomModalClass',
        backdrop: 'static',
  ...
  openModalDanhGiaChuanNgheNghiep(): void {
    const modalRef = this.modalService.open(ModalDanhGiaChuanNgheNghiepStaffComponent,
      {
        scrollable: true,
        windowClass: 'myCustomModalClass',
        backdrop: 'static',
  ...
  openModalKhenThuongGV(): void {
    const modalRef = this.modalService.open(ModalKhenThuongStaffComponent,
      {
        scrollable: true,
        windowClass: 'myCustomModalClass',
        backdrop: 'static',
  ...
  openModalKyLuatGV(): void {
    const modalRef = this.modalService.open(ModalKyLuatStaffComponent,
      {
        scrollable: true,
        windowClass: 'myCustomModalClass',
        backdrop: 'static',
  ...
  openModalQuanHeGiaDinh(): void {
    const modalRef = this.modalService.open(ModalQuanHeGiaDinhStaffComponent,
      {
        scrollable: true,
        windowClass: 'myCustomModalClass',
        backdrop: 'static',
  ...
  openModalQuanHeGiaDinhVoChong(): void {
    const modalRef = this.modalService.open(ModalQuanHeGiaDinhVoChongStaffComponent,
      {
        scrollable: true,
        windowClass: 'myCustomModalClass',
        backdrop: 'static',
  ...
  openModalQuaTrinhCongTac(): void {
    const modalRef = this.modalService.open(ModalQuaTrinhCongTacStaffComponent,
      {
        scrollable: true,
        windowClass: 'myCustomModalClass',
        backdrop: 'static',
