...
import {EmployeeCreateStaffComponent} from "./employee-create-staff.component";
...
describe('EmployeeCreateTenantComponent', () => {
  let component: EmployeeCreateStaffComponent;
  let fixture: ComponentFixture<EmployeeCreateStaffComponent>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      declarations: [EmployeeCreateStaffComponent],
      imports: [
        EmployeeStaffModule,
        CommonModule,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(EmployeeCreateStaffComponent);
