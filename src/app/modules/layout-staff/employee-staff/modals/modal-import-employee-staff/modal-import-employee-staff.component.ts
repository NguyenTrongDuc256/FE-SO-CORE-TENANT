...
@Component({
  selector: 'app-modal-import-employee-staff',
  templateUrl: './modal-import-employee-staff.component.html',
  styleUrls: ['./modal-import-employee-staff.component.scss']
})
export class ModalImportEmployeeStaffComponent implements OnInit {
  @Input() dataModal: any;
