...
@Component({
  selector: 'app-modal-qua-trinh-cong-tac-staff',
  templateUrl: './modal-qua-trinh-cong-tac-staff.component.html',
  styleUrls: ['./modal-qua-trinh-cong-tac-staff.component.scss']
})
export class ModalQuaTrinhCongTacStaffComponent implements OnInit {
