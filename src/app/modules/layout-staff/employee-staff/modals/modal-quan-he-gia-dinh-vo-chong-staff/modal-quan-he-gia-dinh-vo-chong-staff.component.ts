...
@Component({
  selector: 'app-modal-quan-he-gia-dinh-vo-chong-staff',
  templateUrl: './modal-quan-he-gia-dinh-vo-chong-staff.component.html',
  styleUrls: ['./modal-quan-he-gia-dinh-vo-chong-staff.component.scss']
})
export class ModalQuanHeGiaDinhVoChongStaffComponent implements OnInit {
