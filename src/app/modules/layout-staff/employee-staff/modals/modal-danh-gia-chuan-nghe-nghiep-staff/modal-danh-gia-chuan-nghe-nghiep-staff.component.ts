...
@Component({
  selector: 'app-modal-danh-gia-chuan-nghe-nghiep-staff',
  templateUrl: './modal-danh-gia-chuan-nghe-nghiep-staff.component.html',
  styleUrls: ['./modal-danh-gia-chuan-nghe-nghiep-staff.component.scss']
})
export class ModalDanhGiaChuanNgheNghiepStaffComponent implements OnInit {
