...
@Component({
  selector: 'app-modal-khen-thuong-staff',
  templateUrl: './modal-khen-thuong-staff.component.html',
  styleUrls: ['./modal-khen-thuong-staff.component.scss']
})
export class ModalKhenThuongStaffComponent implements OnInit {
