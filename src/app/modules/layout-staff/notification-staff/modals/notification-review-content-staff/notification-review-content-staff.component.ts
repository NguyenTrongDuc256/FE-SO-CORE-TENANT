...
@Component({
  ...
  templateUrl: './notification-review-content-staff.component.html',
  styleUrls: ['./notification-review-content-staff.component.scss']
})
export class NotificationReviewContentStaffComponent implements OnInit {
  @Input() dataModal: any;
  view: number = 1;
