...
import { NotificationCreateStaffComponent } from './notification-create-staff.component';
...
describe('NotificationCreateStaffComponent', () => {
  let component: NotificationCreateStaffComponent;
  let fixture: ComponentFixture<NotificationCreateStaffComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [ NotificationCreateStaffComponent ],
      imports: [
        CommonModule,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(NotificationCreateStaffComponent);
