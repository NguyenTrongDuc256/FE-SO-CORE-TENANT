...
@Component({
  ...
  templateUrl: './notification-edit-staff.component.html',
  styleUrls: ['./notification-edit-staff.component.scss']
})
export class NotificationEditStaffComponent implements OnInit {
