...
import {NotificationList} from "../../../../../_models/layout-staff/notification/notification.model";
...
@Component({
  ...
  templateUrl: './notification-detail-received-staff.component.html',
  styleUrls: ['./notification-detail-received-staff.component.scss']
})
export class NotificationDetailReceivedStaffComponent implements OnInit {
  tabActive = 0;
  ...
  ngOnInit() {
    this.activeRouter.params.subscribe((res: any) => {
      if (res.id) {
        ...
        this.router.navigate(['/staff/notification/received']);
      }
    });
    // this.initForm();
  }
