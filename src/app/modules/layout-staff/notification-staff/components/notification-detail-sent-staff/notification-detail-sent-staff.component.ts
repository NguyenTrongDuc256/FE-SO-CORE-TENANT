...
@Component({
  ...
  templateUrl: './notification-detail-sent-staff.component.html',
  styleUrls: ['./notification-detail-sent-staff.component.scss']
})
export class NotificationDetailSentStaffComponent implements OnInit {
