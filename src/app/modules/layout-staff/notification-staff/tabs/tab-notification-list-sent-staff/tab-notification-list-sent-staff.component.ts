...
@Component({
  selector: 'app-tab-notification-list-sent-staff',
  templateUrl: './tab-notification-list-sent-staff.component.html',
  styleUrls: ['./tab-notification-list-sent-staff.component.scss']
})
export class TabNotificationListSentStaffComponent implements OnInit {
