...
import {
  CategoryStudentRecordsStaffService
} from "../../../../../_services/layout-staff/category-student-records-staff/category-student-records-staff.service";
import {
...
import {
  ...
  AVATAR_DEFAULT, DATA_PERMISSION, PAGE_INDEX_DEFAULT,
  PAGE_SIZE_DEFAULT,
  PAGE_SIZE_OPTIONS_DEFAULT, STATUS_STUDENT_RECORDS, TYPE_CATE_STUDENT_RECORDS
} from "../../../../../_shared/utils/constant";
import {
  ModalRefuseRecordsComponent
} from "../../../student-staff/modals/modal-refuse-records/modal-refuse-records.component";
import { ModalFormRecordsStaffComponent } from "../../modals/modal-form-records-staff/modal-form-records-staff.component";

@Component({
  selector: 'app-approve-profile-student-staff',
  templateUrl: './approve-profile-student-staff.component.html',
  styleUrls: ['./approve-profile-student-staff.component.scss']
})
export class ApproveProfileStudentStaffComponent implements OnInit {
  ...
  getList() {
    ...
    .getListStudentOfRecordsApprove(this.keyword, this.valueDefaultClass, this.statusRecords, this.pageSize, this.pageIndex)
    .subscribe(
      (res: any) => {
  ...
  update(valueUpdate: any) {
    let dataFromParent = {
      userId: valueUpdate.studentUserId,
      ...
      apiSubmit: (dataInput: any) =>
        this.studentRecordsStaffService.update(valueUpdate.fileUserId, dataInput),
      nameForm: 'update',
    };
  ...
  changeStatusRecords(valueChange: any, nameAction: string) {
    let dataFromParent = {
      id: valueChange.studentUserId,
      dataInput: {studentUserId: valueChange.studentUserId, fileUserId: valueChange.fileUserId, approveStatus: null,},
      service: this.studentRecordsStaffService,
      keyFirebaseAction: 'update',
      keyFirebaseModule: 'file-user',
      apiSubmit: (dataInput: any) =>
