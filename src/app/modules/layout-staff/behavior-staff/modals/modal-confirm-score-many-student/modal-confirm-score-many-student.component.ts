...
@Component({
  selector: 'app-modal-confirm-score-many-student',
  templateUrl: './modal-confirm-score-many-student.component.html',
  styleUrls: ['./modal-confirm-score-many-student.component.scss', '../../style.scss']
})
export class ModalConfirmScoreManyStudentComponent implements OnInit {
  ...
  onSubmit(): void {
    ...
    let dataInput: FormInputScoreManyStudent = {
    ...
    this.behaviorStaffService.storeScoreManyStudent(dataInput).subscribe((res: any) => {
