...
@Component({
  selector: 'app-modal-confirm-score-many-student-in-course',
  templateUrl: './modal-confirm-score-many-student-in-course.component.html',
  styleUrls: ['./modal-confirm-score-many-student-in-course.component.scss', '../../style.scss']
})
export class ModalConfirmScoreManyStudentInCourseComponent implements OnInit {
  ...
  onSubmit(): void {
    ...
    this.behaviorStaffService.storeScoreManyStudentCourse(dataInput).subscribe((res: any) => {
