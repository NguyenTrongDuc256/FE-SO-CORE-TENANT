...
@Component({
  selector: 'app-score-student-in-course-staff',
  templateUrl: './score-student-in-course-staff.component.html',
  styleUrls: ['./score-student-in-course-staff.component.scss', '../../style.scss']
})
export class ScoreStudentInCourseStaffComponent implements OnInit {
  ...
  handleForkJoinAPI() {
    ...
    const APIGetBehaviorByCourse = this.behaviorServiceStaff.getBehaviorForCourse(this.courseId, this.userId, this.type);
