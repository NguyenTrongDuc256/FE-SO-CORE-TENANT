...
@Component({
  selector: 'app-result-import-daily-comment-homeroom-class-staff',
  templateUrl: './result-import-daily-comment-homeroom-class-staff.component.html',
  styleUrls: ['./result-import-daily-comment-homeroom-class-staff.component.scss']
})
export class ResultImportDailyCommentHomeroomClassStaffComponent implements OnInit {
