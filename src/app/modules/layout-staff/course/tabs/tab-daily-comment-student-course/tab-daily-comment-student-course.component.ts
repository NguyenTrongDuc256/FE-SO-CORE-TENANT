...
import { ModalGuideDailyCommentComponent } from '../../../homeroom-class/modals/modal-guide-daily-comment/modal-guide-daily-comment.component';

@Component({
  selector: 'app-tab-daily-comment-student-course',
  templateUrl: './tab-daily-comment-student-course.component.html',
  styleUrls: ['./tab-daily-comment-student-course.component.scss']
})
export class TabDailyCommentStudentCourseComponent implements OnInit {
