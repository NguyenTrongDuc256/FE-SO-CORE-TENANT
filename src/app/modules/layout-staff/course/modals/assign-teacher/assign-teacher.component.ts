...
@Component({
  selector: 'app-assign-teacher-course',
  templateUrl: './assign-teacher.component.html',
  styleUrls: ['./assign-teacher.component.scss', '../../helper.scss']
})
export class AssignTeacherCourseComponent implements OnInit {
  isLoading = false;
  classId = '';
  keyword = '';
  ...
  getListUsers() {
    ...
    getListTeacherToAssignCourse(this.dataFromParent.infoClass.id, this.pageIndex, this.pageSize, this.keyword)
      .subscribe(
        (res: any) => {
