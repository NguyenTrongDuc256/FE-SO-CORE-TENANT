...
@Component({
  selector: 'app-modal-quan-he-gia-dinh',
  templateUrl: './modal-quan-he-gia-dinh.component.html',
  styleUrls: ['./modal-quan-he-gia-dinh.component.scss']
})
export class ModalQuanHeGiaDinhComponent implements OnInit {
  ...
  update(dataForm, index): void {
    ((this.formGroup.get('qhGiaDinh') as FormArray).at(index) as FormGroup).get('moiQuanHe').patchValue(dataForm.moiQuanHe);
    ((this.formGroup.get('qhGiaDinh') as FormArray).at(index) as FormGroup).get('fullName').patchValue(dataForm.fullName);
    ((this.formGroup.get('qhGiaDinh') as FormArray).at(index) as FormGroup).get('dateOfBirth').patchValue(dataForm.dateOfBirth);
    ((this.formGroup.get('qhGiaDinh') as FormArray).at(index) as FormGroup).get('content').patchValue(dataForm.content);
    ((this.formGroup.get('qhGiaDinh') as FormArray).at(index) as FormGroup).get('isInput').patchValue(0);
