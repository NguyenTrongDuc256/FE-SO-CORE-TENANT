...
@Component({
  ...
  templateUrl: './notification-create-tenant.component.html',
  styleUrls: ['./notification-create-tenant.component.scss']
})
export class NotificationCreateTenantComponent implements OnInit {
  ...
  onSubmit(formValue): void {
    if (this.formGroup.valid && this.checkedNumberTrue > 0) {
      this.isLoading = true;
      // formValue.
      const dataInput: NotificationStore = {
