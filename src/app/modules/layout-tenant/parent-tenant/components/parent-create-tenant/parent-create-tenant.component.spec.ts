...
import { ParentCreateTenantComponent } from './parent-create-tenant.component';
...
describe('ParentCreateTenantComponent', () => {
  ...
  let fixture: ComponentFixture<ParentCreateTenantComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [ ParentCreateTenantComponent ],
      imports: [
        CommonModule,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ParentCreateTenantComponent);
