...
@Component({
  selector: 'app-result-import-parent-tenant',
  templateUrl: './result-import-parent-tenant.component.html',
  styleUrls: ['./result-import-parent-tenant.component.scss']
})
export class ResultImportParentTenantComponent implements OnInit {
