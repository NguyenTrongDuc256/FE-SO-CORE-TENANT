...
@Component({
  ...
  templateUrl: './notification-list-sent-teacher.component.html',
  styleUrls: ['./notification-list-sent-teacher.component.scss', '../../helper.scss']
})
export class NotificationListSentTeacherComponent implements OnInit {
