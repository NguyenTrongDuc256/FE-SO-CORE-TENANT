...
import { NotificationEditTeacherComponent } from './notification-edit-teacher.component';
...
describe('NotificationEditTeacherComponent', () => {
  let component: NotificationEditTeacherComponent;
  let fixture: ComponentFixture<NotificationEditTeacherComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [ NotificationEditTeacherComponent ],
      imports: [
        CommonModule,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(NotificationEditTeacherComponent);
