...
@Component({
  ...
  templateUrl: './notification-edit-teacher.component.html',
  styleUrls: ['./notification-edit-teacher.component.scss']
})
export class NotificationEditTeacherComponent implements OnInit {
