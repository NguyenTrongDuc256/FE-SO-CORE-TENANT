...
@Component({
  ...
  templateUrl: './notification-list-received-teacher.component.html',
  styleUrls: ['./notification-list-received-teacher.component.scss', '../../helper.scss']
})
export class NotificationListReceivedTeacherComponent implements OnInit {
