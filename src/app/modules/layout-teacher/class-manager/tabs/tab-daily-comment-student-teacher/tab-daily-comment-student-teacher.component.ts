...
@Component({
  selector: 'app-tab-daily-comment-student-teacher',
  templateUrl: './tab-daily-comment-student-teacher.component.html',
  styleUrls: ['./tab-daily-comment-student-teacher.component.scss']
})
export class TabDailyCommentStudentTeacherComponent implements OnInit {
