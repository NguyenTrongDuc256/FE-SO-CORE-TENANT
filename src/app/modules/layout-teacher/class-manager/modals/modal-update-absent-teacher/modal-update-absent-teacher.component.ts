...
@Component({
  selector: 'app-modal-update-absent-teacher',
  templateUrl: './modal-update-absent-teacher.component.html',
  styleUrls: ['./modal-update-absent-teacher.component.scss']
})
export class ModalUpdateAbsentTeacherComponent implements OnInit {
  @Input() dataModal: any;
  ...
  updateAbsent() {
    ...
    this.classManagerService.updateAbsent(dataRequest).subscribe((res: any) => {
