...
@Component({
  selector: 'app-modal-create-absent-teacher',
  templateUrl: './modal-create-absent-teacher.component.html',
  styleUrls: ['./modal-create-absent-teacher.component.scss']
})
export class ModalCreateAbsentTeacherComponent implements OnInit {
  @Input() dataModal: any;
  ...
  getListStudentInClass() {
    this.classManagerService.getListStudentInClass(this.dataModal?.dataFromParent).subscribe((res: any) => {
  ...
  getListPeriod() {
    this.classManagerService.getListPeriod().subscribe((res: any) => {
  ...
  createAbsent() {
    ...
    let dataRequest = {
      classId: this.dataModal?.dataFromParent,
      homeroomclassId: this.dataModal?.dataFromParent,
    ...
    this.listenFireBase('create', 'absent');
    this.classManagerService.createAbsent(dataRequest).subscribe((res: any) => {
      this.isLoading = false;
    }, (err: any) => {
      this.isLoading = false;
