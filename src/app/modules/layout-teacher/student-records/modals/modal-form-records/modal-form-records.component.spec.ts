...
describe('ModalFormRecordsTeacherComponent', () => {
  ...
  let fixture: ComponentFixture<ModalFormRecordsTeacherComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [ModalFormRecordsTeacherComponent],
      imports: [
        CommonModule,
        CoreModule,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ModalFormRecordsTeacherComponent);
