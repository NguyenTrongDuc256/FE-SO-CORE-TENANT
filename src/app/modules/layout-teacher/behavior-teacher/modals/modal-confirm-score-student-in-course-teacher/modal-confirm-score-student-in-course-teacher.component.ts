...
import {FormInputScoreStudentCourse} from "../../../../../_models/layout-teacher/behavior/score-behavior-teacher.model";
...
@Component({
  selector: 'app-modal-confirm-score-student-in-course-teacher',
  templateUrl: './modal-confirm-score-student-in-course-teacher.component.html',
  styleUrls: ['./modal-confirm-score-student-in-course-teacher.component.scss', '../../style.scss']
})
export class ModalConfirmScoreStudentInCourseTeacherComponent implements OnInit {
  @Input() dataModal: any;
  formValue: any;
  behaviorList: any;
  ...
  onSubmit(): void {
    ...
    this.behaviorTeacherService.storeScoreStudentCourse(dataInput).subscribe((res: any) => {
