...
import {
  ...
  BehaviorCategories,
  Course,
  FormInputScoreManyStudentCourse,
...
@Component({
  selector: 'app-modal-confirm-score-many-student-in-course-teacher',
  templateUrl: './modal-confirm-score-many-student-in-course-teacher.component.html',
  styleUrls: ['./modal-confirm-score-many-student-in-course-teacher.component.scss', '../../style.scss']
})
export class ModalConfirmScoreManyStudentInCourseTeacherComponent implements OnInit {
  ...
  onSubmit(): void {
    ...
    this.behaviorTeacherService.storeScoreManyStudentCourse(dataInput).subscribe((res: any) => {
