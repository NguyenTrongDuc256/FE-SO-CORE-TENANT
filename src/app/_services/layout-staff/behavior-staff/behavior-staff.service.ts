...
export class BehaviorStaffService {
  ...
  getStudentBySchool(body: any) {
    return this.http.post(`${environment.apiBehaviorService}/api/grading-behavior/students`, body);
  }
  // 16. Confirm chấm điểm theo học sinh
  getConfirmScoreStudent(body) {
    return this.http.post(`${environment.apiBehaviorService}/api/grading-behavior/confirm-grading-multi-student-info`, body);
  }
