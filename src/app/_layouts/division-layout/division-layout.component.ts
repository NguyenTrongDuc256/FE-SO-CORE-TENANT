...
@Component({
  selector: 'app-division-layout',
  templateUrl: './division-layout.component.html',
  styleUrls: ['./division-layout.component.scss'],
})
export class DivisionLayoutComponent implements OnInit, AfterViewInit {
  // Public variables
  selfLayout = 'teacher';
